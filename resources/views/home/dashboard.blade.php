...
<div class="container mt-3">
    <div class="glass">
        <div class="row">
            <h2 class="d-flex justify-content-center" style="color:aliceblue ;" data-aos="zoom-in-up"> Produk
            </h2>
            @foreach ($produks as $produk)
            <div class="col-md-4">
                <div class="card mt-3 mb-3" style="margin-left: 5px ;">
                    <div class="card-body">
                        ...
                        <a class="btn btn-dark btn-sm rounded shadow"> {{ $tag->name  }}</a>
                        @endforeach
                        @if ($produk->kategori->name == !null)
                        <p class="card-text">bahan:<a href="{{ route('kategori', $produk->kategori->slug) }}" style="text-decoration:none ;">{{ $produk->kategori->name }} </a></p>
                        @endif
                        <div>
